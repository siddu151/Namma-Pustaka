...
import com.example.nammapustaka.adapters.TransactionRowsAdapter
import com.example.nammapustaka.databinding.FragmentTransactionsBinding
...
class TransactionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = TransactionRowsAdapter()
